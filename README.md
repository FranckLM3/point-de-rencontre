...
ou chacun avec son moyen, en temps ou en prix ; métro, RER et tram en Île-de-France,
à Lyon et à Marseille.

Spécification : `docs/superpowers/specs/2026-09-17-point-de-rencontre-design.md`.
Plans : `docs/superpowers/plans/` (plans 1 à 4).
...
- `npm run urbain` : télécharge les horaires de métro, RER et tram (IDFM, TCL, RTM) et
  calcule les durées entre stations dans `public/data/urbain/` (moins d'une minute, non commité).
...
Les horaires SNCF sont recalculés (40 à 50 min) seulement quand le code du calcul change, chaque mercredi à 4 h 23 UTC, ou sur demande (Actions, pages, « Run workflow » avec « Recalculer les horaires »). Sinon la publication reprend le dernier calcul en réserve et prend quelques minutes. Les réseaux urbains suivent la même règle avec leur propre réserve (calcul d'une minute) ; s'ils manquent, la page est publiée sans eux et l'accès aux gares se fait à pied puis en voiture.
